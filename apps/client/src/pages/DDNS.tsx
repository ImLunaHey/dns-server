              ...
              <DataTable
                ...
                columns={[
                  ...
                  { header: "Record Type", accessor: "recordType" },
                  {
                    header: "Update URL",
                    accessor: (row) => {
                      const isVisible = visibleTokens.has(row.id);
                      ...
                      return (
                        <div className="flex items-center gap-2">
                          <code className="text-xs bg-gray-100 dark:bg-gray-800 px-3 py-2 rounded block break-all font-mono flex-1">
                          ...
                          <button
                            onClick={() => {
                              ...
                              if (isVisible) {
                                newVisible.delete(row.id);
                              } else {
                                newVisible.add(row.id);
                              }
